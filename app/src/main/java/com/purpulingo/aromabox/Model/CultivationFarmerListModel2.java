...
public class CultivationFarmerListModel2 {

    String farmerName, farmerId, farmerVillage, farmerImg, farmerArea, lastCutting, nextCutting, lastIrrigation, lastFertigation;

    public CultivationFarmerListModel2(String farmerName, String farmerId, String farmerVillage, String farmerImg,
                                       String farmerArea, String lastCutting, String nextCutting, String lastIrrigation, String lastFertigation) {
